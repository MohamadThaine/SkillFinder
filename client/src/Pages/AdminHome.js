...
import simulationIcon from '../Assets/Images/laptop-solid-white.svg';
...
function AdminHome({ isAdmin }) {
    ...
    return (
        <div className="container mt-auto mb-auto d-flex justify-content-center">
            ...
            <div className="text-center admin-buttons-row">
                <Button variant="contained" onClick={() => navigate('/Admin/Simulations')}>
                    <img src={simulationIcon} alt="user" className="admin-nav-bar-icons" />
                    Simulations
                </Button>
            </div>
        </div>
